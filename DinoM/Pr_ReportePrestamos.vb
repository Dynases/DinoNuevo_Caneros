...
Public Class Pr_ReportePrestamos
    ...
    End Sub
    Private Sub Pr_ReportePrestamos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        iniciarcomponentes()
    End Sub
    ...
    Public Sub _prInterpretarDatos(ByRef _dt As DataTable)
        If CheckUna.Checked = True And CheckTodosCan.Checked = True Then
            _dt = L_prReporteRetiroCaneroUno1(tbCod.Text, 0, tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"))
        End If
        If CheckUna.Checked = True And CheckUnaCan.Checked = True Then
            _dt = L_prReporteRetiroCaneroUno1(tbCod.Text, tbCodCan.Text, tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"))
        End If
        If CheckTodos.Checked = True Then
            _dt = L_prReporteRetiroCaneroUno1(0, 0, tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"))
