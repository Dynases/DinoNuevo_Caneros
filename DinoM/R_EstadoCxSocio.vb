...
Public Class R_EstadoCxSocio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_EstadoCxSocio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_EstadoCxSocio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_EstadoCxSocio = New R_EstadoCxSocio()
        rpt.Site = Me.Site
        Return rpt
    End Function
