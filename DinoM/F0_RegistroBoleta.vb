...
#Region "Metodos Privados"
    ...
    Private Sub _prCargarDetalleVenta(_numi As String)
        ...
        With grdetalle.RootTable.Columns("producto")
            ...
            '.Columns[2].Header1.Caption="Número Comprobante"

            .WordWrap = True
            .MaxLines = 2
            .Caption = "Welcome! Second " + Chr(13) + "Lineffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
        ...
        With grdetalle.RootTable.Columns("tbcmin")
            ...
            .Visible = True
            .FormatString = "0"
            .Caption = "Código de Tara".ToUpper
        End With
        ...
        With grdetalle.RootTable.Columns("unidad")
            ...
            .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
            .Visible = True
            .Caption = "1=Entera / 2=Picada.".ToUpper
        End With
        With grdetalle.RootTable.Columns("tbest")
            .Width = 50
            .CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
            .Visible = False
            .Caption = "Detalle Tipo de Caña.".ToUpper
        End With
        ...
        With grdetalle.RootTable.Columns("tbptot")
            ...
            .Visible = True
            .FormatString = "0.00"
            .Caption = "Peso Tara Vehiculo".ToUpper
        End With
        ...
        With grdetalle.RootTable.Columns("tbtotdesc")
            ...
            .Visible = True
            .FormatString = "0.00"
            .Caption = "Peso Neto Paquete".ToUpper
        End With
        ...
        If (_fnAccesible()) Then
            ...
            If e.KeyData = Keys.Control + Keys.Enter Then
                ...
                If (bandera = True) Then
                    ...
                    'tbNit.Text = Row.Cells("ydnumiInstitucion").Value
                    TbNombre1.Text = Row.Cells("ydnumi").Value
        ...
        If (_fnAccesible()) Then
            ...
            If (e.Column.Index = grdetalle.RootTable.Columns("tbcmin").Index Or
                e.Column.Index = grdetalle.RootTable.Columns("tbporc").Index Or
                 e.Column.Index = grdetalle.RootTable.Columns("producto").Index Or
