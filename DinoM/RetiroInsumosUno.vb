...
Public Class RetiroInsumosUno
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.RetiroInsumosUno.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRetiroInsumosUno
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RetiroInsumosUno = New RetiroInsumosUno()
        rpt.Site = Me.Site
        Return rpt
    End Function
