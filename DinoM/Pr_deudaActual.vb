...
Public Class Pr_DeudaActual
    ...
    Private Function interpretarDatos() As DataTable
        ...
        If swTipo.Value = True Then
            ...
            Else
                dt = CargarDeudaActual(IIf(CheckTodosCan.Checked = True, -1, tbCodCan.Text), IIf(CheckTodos.Checked = True, -1, tbCod.Text), IIf(cbQuincena.Value = 0, -1, cbQuincena.Value), tbFechaI.Value.ToString("dd/MM/yyyy"), tbFechaF.Value.ToString("dd/MM/yyyy"))
    ...
    Private Sub btnGenerar_Click(sender As Object, e As EventArgs) Handles btnGenerar.Click
        ...
        If dt.Rows.Count > 0 Then
            If swTipo.Value = True Then
                Dim objrep As New R_DeudaActual
