...
Public Class R_CCPagosSaldos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_CCPagosSaldos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_CCPagosSaldos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_CCPagosSaldos = New R_CCPagosSaldos()
        rpt.Site = Me.Site
        Return rpt
    End Function
