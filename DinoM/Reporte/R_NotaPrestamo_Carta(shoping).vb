...
Public Class R_NotaPrestamo_Cartashoping
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_NotaPrestamo_Carta(shoping).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_NotaPrestamo_Carta(shoping).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_NotaPrestamo_Cartashoping
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_NotaPrestamo_Cartashoping = New R_NotaPrestamo_Cartashoping()
        rpt.Site = Me.Site
        Return rpt
    End Function
