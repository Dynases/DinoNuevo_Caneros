...
Public Class R_ResumenDiario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_ResumenDiario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_ResumenDiario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_ResumenDiario = New R_ResumenDiario()
        rpt.Site = Me.Site
        Return rpt
    End Function
