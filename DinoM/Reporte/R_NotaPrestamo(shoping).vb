...
Public Class R_NotaPrestamoshoping
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_NotaPrestamo(shoping).rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_NotaPrestamo(shoping).rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_NotaPrestamoshoping
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_NotaPrestamoshoping = New R_NotaPrestamoshoping()
        rpt.Site = Me.Site
        Return rpt
    End Function
