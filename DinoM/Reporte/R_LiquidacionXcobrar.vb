...
Public Class R_LiquidacionXcobrar
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "R_LiquidacionXcobrar.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_LiquidacionXcobrar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedR_LiquidacionXcobrar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_LiquidacionXcobrar = New R_LiquidacionXcobrar()
        rpt.Site = Me.Site
        Return rpt
    End Function
