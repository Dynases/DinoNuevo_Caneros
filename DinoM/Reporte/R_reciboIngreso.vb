...
Public Class R_reciboIngreso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DinoM.R_reciboIngreso.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_fechaLiteral() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedR_reciboIngreso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As R_reciboIngreso = New R_reciboIngreso()
        rpt.Site = Me.Site
        Return rpt
    End Function
